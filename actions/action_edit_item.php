...
if (!Item::update_item($dbh, $item, $_POST['iname'], $_POST['description'], round($_POST['price']/ User::get_currency_conversion($dbh, $session->getCurrency()), 2), Tag::get_category_id($dbh, $_POST['category']))) {
