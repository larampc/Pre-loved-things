...
$item_id = Item::register_item($dbh, htmlentities($_POST['item-name']), htmlentities($_POST['description']),  round($_POST['price']/ Currency::get_currency_conversion($dbh, $session->get_currency()), 2), $_POST['category'] == "other" ? "" : $_POST['category'], $session->get_id(), $img_ids[0]);
